...
namespace System.Management.Automation
{
    ...
    public static class LanguagePrimitives
    {
        ...
        {
            //                        short            int              long             ushort           uint             ulong            sbyte            byte             float             double            decimal
            /* short   */new Type[] { typeof(short),   typeof(int),     typeof(long),    typeof(int),     typeof(long),    typeof(double),  typeof(short),   typeof(short),   typeof(float),    typeof(double),   typeof(decimal) },
            /* int     */new Type[] { typeof(int),     typeof(int),     typeof(long),    typeof(int),     typeof(long),    typeof(double),  typeof(int),     typeof(int),     typeof(double),   typeof(double),   typeof(decimal) },
            /* long    */new Type[] { typeof(long),    typeof(long),    typeof(long),    typeof(long),    typeof(long),    typeof(decimal), typeof(long),    typeof(long),    typeof(double),   typeof(double),   typeof(decimal) },
            /* ushort  */new Type[] { typeof(int),     typeof(int),     typeof(long),    typeof(ushort),  typeof(uint),    typeof(ulong),   typeof(int),     typeof(ushort),  typeof(float),    typeof(double),   typeof(decimal) },
            /* uint    */new Type[] { typeof(long),    typeof(long),    typeof(long),    typeof(uint),    typeof(uint),    typeof(ulong),   typeof(long),    typeof(uint),    typeof(double),   typeof(double),   typeof(decimal) },
            /* ulong   */new Type[] { typeof(double),  typeof(double),  typeof(decimal), typeof(ulong),   typeof(ulong),   typeof(ulong),   typeof(double),  typeof(ulong),   typeof(double),   typeof(double),   typeof(decimal) },
            /* sbyte   */new Type[] { typeof(short),   typeof(int),     typeof(long),    typeof(int),     typeof(long),    typeof(double),  typeof(sbyte),   typeof(short),   typeof(float),    typeof(double),   typeof(decimal) },
            /* byte    */new Type[] { typeof(short),   typeof(int),     typeof(long),    typeof(ushort),  typeof(uint),    typeof(ulong),   typeof(short),   typeof(byte),    typeof(float),    typeof(double),   typeof(decimal) },
            /* float   */new Type[] { typeof(float),   typeof(double),  typeof(double),  typeof(float),   typeof(double),  typeof(double),  typeof(float),   typeof(float),   typeof(float),    typeof(double),   null/*not used*/ },
            /* double  */new Type[] { typeof(double),  typeof(double),  typeof(double),  typeof(double),  typeof(double),  typeof(double),  typeof(double),  typeof(double),  typeof(double),   typeof(double),   null/*not used*/ },
            /* decimal */new Type[] { typeof(decimal), typeof(decimal), typeof(decimal), typeof(decimal), typeof(decimal), typeof(decimal), typeof(decimal), typeof(decimal), null/*not used*/, null/*not used*/, typeof(decimal) },
        };
